...
function Sidenav() {
  return (
    <>
      <nav className = "left-0 bg-white shadow-md w-full">
        <div className = "container m-auto flex justify-between items-center">
          ...
          <button className = "block lg:hidden py-3 px-4 mx-2 rounded focus:outline-none group">
            ...
            <div className = "absolute -right-full h-screen w-8/12 border opacity-0 group-focus:right-0 group-focus:opacity-100 transition-all duration-300 bg-blue-400 mt-5">
      ...
      <section className = "mt-10 px-4 h-screen overflow-scroll">
        <p className = "mb-2">
